...
TFremap=fread(file.path(data_annot,"subset_remap2022_nr_macs2_hg19_v1_0.bed"), head=FALSE)
...
write.table(a, file = paste0(data_annot,"/TFs_highly_present.txt"), sep = "\t",row.names = FALSE, quote = FALSE)
