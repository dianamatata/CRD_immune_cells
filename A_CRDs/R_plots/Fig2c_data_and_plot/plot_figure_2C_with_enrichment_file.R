...
summary <- read.csv(file=paste0("/Users/dianaavalos/Desktop/reviews_avalos/CRD_immune_cells/A_CRDs/R_plots/Fig2c_data_and_plot/enrichment_hCRD_QTLs_plot2c.txt"), sep="\t", header=TRUE,skip = 0)
thresh=1e-05
...
png(paste0("/Users/dianaavalos/Desktop/figure_CRD_blood_GWAS_",thresh,"1.png"), 2100, 2100, res=300)
